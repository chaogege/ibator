...
public class InsertSelectiveElementGenerator extends AbstractXmlElementGenerator {
    ...
    public void addElements(XmlElement parentElement) {
        ...
        answer.addAttribute(new Attribute("id", "add" + table.getDomainObjectName())); //$NON-NLS-1$
        ...
        for (IntrospectedColumn introspectedColumn : introspectedTable.getAllColumns()) {
            ...
            insertNotNullElement.addElement(new TextElement(introspectedColumn
            ...
            valuesNotNullElement.addAttribute(new Attribute(
                "property", introspectedColumn.getJavaProperty())); //$NON-NLS-1$
            valuesNotNullElement.addElement(new TextElement(introspectedColumn
        ...
        if (ibatorContext.getPlugins().sqlMapInsertSelectiveElementGenerated(answer,
            introspectedTable)) {
